...
void setup()
{
	// tell FastLED about the LED strip configuration
		FastLED.addLeds<LED_TYPE, 5>(leds, 0, 32).setDither(BRIGHTNESS < 255); // cpt-city palettes have different color balance
		FastLED.addLeds<LED_TYPE, 4>(leds, 32, 32).setDither(BRIGHTNESS < 255);
		FastLED.addLeds<LED_TYPE, 3>(leds, 64, 32).setDither(BRIGHTNESS < 255);
		FastLED.addLeds<LED_TYPE, 2>(leds, 96, 32).setDither(BRIGHTNESS < 255);
